...
load(file="C://Users/g557428/Projects/seis736_ml_project/models/logit4.rdata")
...
# Write to csv
write.csv(x=out, file="C://Users/g557428/Projects/seis736_ml_project/data/processed/cs-final-3.csv")
