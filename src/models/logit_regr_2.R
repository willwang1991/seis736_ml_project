...
################################################################
# Use linear regression to identify outliers in the 
# final dataset & remove those outliers for a better
# overall fit
################################################################
...
fit <- cv.glmnet(x, y, nfolds=10, family="binomial", type.measure="class", alpha=1)
...
save(fit, file="C://Users/g557428/Projects/seis736_ml_project/models/logit4.rdata")
