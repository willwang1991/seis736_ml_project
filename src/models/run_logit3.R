...
load(file="C://Users/g557428/Projects/seis736_ml_project/models/logit5.rdata")
...
# Prepare the dataset for input into the model
...
# Final output
out <- data.frame(pred[,2])
colnames(out)[1] <- "Probability"

# Write to csv
write.csv(x=out, file="C://Users/g557428/Projects/seis736_ml_project/data/processed/cs-final-4.csv")
